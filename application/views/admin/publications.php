        ...
        <div class="col-md-9">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Publikácie pracoviska <?php echo $name; ?></h3>
                </div>
                <div class="panel-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <?php } ?>
                        <hr />
                        <?php echo anchor('profile_edit/add_publication/'.$idl, 'Pridať novú publikáciu', 'class="btn btn-lg btn-success btn-block"'); ?>
