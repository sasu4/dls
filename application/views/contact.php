<section id="title" class="emerald">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <h1>Napíšte nám</h1>
                <p>Ak sa zaujímate o možnosť štúdia slovenského jazyka v zahraničí, o aktivity Studia Academica Slovaka alebo si myslíte, že na stránke nejaká informácia chýba, budeme radi, keď nám napíšete.
                </p>
            </div>
            <div class="col-sm-6">
...
<section id="contact-page" class="container">
    <div class="row">
        <div class="col-sm-8">
            ...
            <?php echo form_open('contact/sent'); ?>
            <!--<form id="main-contact-form" class="contact-form" name="contact-form" method="post" action="sendemail.php" role="form">-->
                <div class="row">
                    <div class="col-sm-5">
                        <div class="form-group">
                            <?php echo form_input('name','','required="required" class="form-control" placeholder="meno"'); ?>
                            <!--<input type="text" class="form-control" required="required" placeholder="meno">-->
                        </div>
                        <div class="form-group">
                            <?php echo form_input('surname','','required="required" class="form-control" placeholder="priezvisko"'); ?>
                            <!--<input type="text" class="form-control" required="required" placeholder="priezvisko">-->
                        </div>
                        <div class="form-group">
                            <?php echo form_input('email','','required="required" class="form-control" placeholder="email"'); ?>
                            <!--<input type="text" class="form-control" required="required" placeholder="email">-->
                        </div>
                        <div class="form-group">
                            <?php echo form_submit('contact/sent', 'Poslať správu', 'class="btn btn-lg btn-primary"'); ?>
                            <!--<button type="submit" class="btn btn-primary btn-lg">Poslať správu</button>-->
                        </div>
                    </div>
                    <div class="col-sm-7">
                        <?php echo form_textarea('message','','required="required" class="form-control" rows="8" placeholder="správa"'); ?>
